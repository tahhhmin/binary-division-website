...
import { Loader2, Trash2, Edit, ExternalLink, Plus, X, Link } from "lucide-react";
        ...
        <div className={styles.pageWrapper}>
            <div className={styles.container}>
                ...
                <Tabs defaultValue="list">
                    ...
                    {/* NEWS LIST TAB */}
<TabsContent value="list" className={styles.tabsContent}>
  <div className={styles.card}>
    <div className={styles.cardHeader}>
      <h4>News Articles List</h4>
    </div>
      ...
      <ScrollArea>
        {news.length === 0 ? (
          ...
          <div className={styles.newsContainer}>
            {news.map((item) => (
              <div key={item._id} className={styles.newsCardWrapper}>
                    ...
                    {item.links && item.links.length > 0 && (
                      <div className={styles.linksWrapper}>
                        {item.links.map((link, idx) => (
                          <a key={idx} href={link} target="_blank" className={styles.linkItem}>
                            <ExternalLink />
                            Link {idx + 1}
                          </a>
                        ))}
  ...
  <Card>
    ...
    <CardContent>
      <form onSubmit={handleSubmit} className={styles.formWrapper}>
        ...
        {/* IMAGE */}
        <div className={styles.formGroup}>
          <Label htmlFor="imageLink" className={styles.label}>Image URL *</Label>
          <Input
            id="imageLink"
            type="url"
            name="imageLink"
        ...
        {/* LINKS */}
        <div className={styles.formGroup}>
          <Label className={styles.label}>Related Links</Label>
